# 39 — Arquitetura de Ledger, Saldo e Repasse

## Status

Implementado no escopo inicial de STORE_BALANCE_TRANSACTION, view
STORE_BALANCE, COMMISSION e PAYOUT. Evoluções de integração bancária externa e
automação de repasse exigem contrato próprio.
